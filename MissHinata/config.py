...
def get_user_list(config, key):
    with open('{}/MissHinata/{}'.format(os.getcwd(), config), 'r') as json_file:
...
class Config(object):
    ...
    OWNER_USERNAME = "imDivu"
    SUPPORT_CHAT = 'MissHinataSupport'  #Your own group for support, do not add the @
    JOIN_LOGGER = -437931199  #Prints any new group the bot is added to, prints just the name and ID.
    EVENT_LOGS = -437931199  #Prints information like gbans, sudo promotes, AI enabled disable states that may help in debugging and shit
